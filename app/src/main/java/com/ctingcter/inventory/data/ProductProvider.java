...
public class ProductProvider extends ContentProvider {
    ...
    // URI matcher code ffor the content URI for a single product in the products table
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        // See if the URI matcher can match the URI to a specific code
        ...
        switch (match) {
            ...
            case PRODUCT_ID:
                ...
                // Perform a query on the products table where the _id equals 3 to return
    ...
    public Uri insertProduct(Uri uri, ContentValues values) {
        ...
        if (!ProductEntry.isValidPrice(price)) {
            throw new IllegalArgumentException("Price must be in format £.pp");
        }
        ...
        // if the ID -1, then the insertion failed.  Log an error and return null.
        if (id == -1) {
